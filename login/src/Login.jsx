...
const Login = () => {
  ...
  //         const result = await axios.post('http://localhost:3001/login', { user, pass });
  ...
  return (
    <div className='text-white h-[100vh] w-[100%] flex justify-center items-center bg-cover' style={{ backgroundImage: "url('../src/assets/bg-1.jpg')" }}>
