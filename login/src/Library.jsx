        ...
        <div className="h-screen flex">
          ...
          <div className="h-[85%] w-[75%] bg-black flex absolute ml-[25%] rounded-2xl opacity-85">
            ...
            <IoMdSearch className='text-white absolute  ml-[69%] w-8 h-6 top-[88px] '/> */}
                ...
                <button className="absolute text-white ml-[80%] top-20 bg-[#484848] w-32 h-9 rounded-2xl ">
                  Dark mode
                </button>
                <hr className="mt-5 mr-4"></hr>
                <div className="text-white ml-10 mt-10 flex flex-col gap-4">
                  <div className="flex gap-3">
                    <Link className="flex gap-3 " to="/playlist">
                      <BsPlusCircleFill className="w-6 h-8" />
                      <p className=" font-semibold text-lg mt-">
                        Create a playlist
                      </p>
                    </Link>
                  </div>
